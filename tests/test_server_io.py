...
from faraday_client.persistence.server import server_io_exceptions
...
class ClientServerAPITests(unittest.TestCase):
    ...
    def setUp(self):
        self.ws_name = "a_ws"
        self.server_api_url = "http://localhost:5985/_api"
    ...
    def test_faraday_dictionary_dispatcher_result(self):
        ...
        with patch('faraday_client.persistence.server.server._get_raw_hosts', mock_raw_hosts):
    ...
    @patch('faraday_client.persistence.server.server._get_raw_hosts')
    @patch('faraday_client.persistence.server.server._get_raw_vulns')
    @patch('faraday_client.persistence.server.server._get_raw_services')
    @patch('faraday_client.persistence.server.server._get_raw_notes')
    @patch('faraday_client.persistence.server.server._get_raw_credentials')
    @patch('faraday_client.persistence.server.server._get_raw_commands')
    ...
    @patch('faraday_client.persistence.server.server.get_hosts', return_value='hosts')
    @patch('faraday_client.persistence.server.server.get_vulns', return_value='vulns')
    @patch('faraday_client.persistence.server.server.get_services', return_value='services')
    @patch('faraday_client.persistence.server.server.get_credentials', return_value='CREDENTIAL')
    @patch('faraday_client.persistence.server.server.get_notes', return_value='NOTE')
    @patch('faraday_client.persistence.server.server.get_commands', return_value='COMMAND')
